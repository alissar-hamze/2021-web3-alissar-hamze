...
if ($UC == 'SEND') {
    ...
    $query = "SELECT * FROM patient where firstName='$search' order by lastName ASC";
    $result = mysqli_query($con, $query);
    include 'Form_SearchP.php';
    if (mysqli_num_rows($result) > 0) {
        $line = mysqli_fetch_array($result, MYSQLI_ASSOC);
        echo '<form action="ViewPatient.php" style="margin-left: 200px ; margin-top:300px">';
